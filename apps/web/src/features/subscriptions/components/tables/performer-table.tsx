/**
 * Performer Table Component
 * Presentational component for displaying performer subscriptions in table format
 */
...
export function PerformerTable({ subscriptions, onDelete, isDeletePending }: PerformerTableProps) {
  return (
    <Card>
      <Table>
        <TableHeader>
