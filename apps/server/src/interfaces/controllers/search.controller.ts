...
export class SearchController {
  ...
  async getPerformerDetails(params: { id: string }) {
    ...
    return this.mapPerformerToSchema(performer as MetadataPerformer);
  }
  ...
  async getStudioDetails(params: { id: string }) {
    ...
    return this.mapStudioToSchema(studio as MetadataStudio);
  }
  ...
  async getSceneDetails(params: { id: string }) {
    ...
    return this.mapSceneToSchema(scene as MetadataScene);
  }
}
